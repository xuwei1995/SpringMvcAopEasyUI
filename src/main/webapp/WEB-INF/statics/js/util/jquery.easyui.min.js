 ...
 *
 *修改tree 位于：1434 开始
 *修改datagrid  位于：datagrid-head  7311 7312   datagrid-body 8953 8954
 *修改datagrid  位于7192 ，修改前检索的时候无法显示数据
 *修改pagination 位于：865 906 1000
 */
(function ($) {
    $.parser = {
        auto: true,
...
(function ($) {
    function _80(_81) {
        ...
        var _83 = _82.options;
        var bb = _82.bb = {};
        var _84 = $(_81).addClass("pagination").html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr></tr></table>");//这个table就是固定datagrid的上下翻页的table
        var tr = _84.find("tr");
        ...
        if (_83.showPageList) {
            ...
            $(".datagrid-pager").each(function () {
                var xx = $(".datagrid-pager").children("select").length;
                if ($(this).children("select").length < 1) {
                    $(this).append(ps);
                }
            });

            // $("<td></td>").append(ps).appendTo(tr);  //改变页面记录条数设置 3-2
...
//$("<div class=\"pagination-info\"></div>").appendTo(_84);//这个div就是固定显示一个页面有多少条数据的那部分
        $("<div class=\"pagination-info\"></div>").prependTo(_84);
//if ($(".datagrid-pager").has(".pagination-page-list").length < 1) {
//    ps.appendTo(".datagrid-pager");
//}//将设置页面显示记录条数的下拉框移到pagenation下面
...
//beforePageText: "跳转到第", afterPageText: "{page}页", displayMsg: "第 {from}-{to} 项，共 {total} 项&nbsp;&nbsp;|&nbsp;&nbsp;每页显示",  3-1
    ...
    function _fe(_ff, ul, data, _100) {
        ...
        function _104(ul, _106, _107) {
            for (var i = 0; i < _106.length; i++) {
                ...
                /*为了把checkbox 和 file,folder 树Icon 的显示前后顺序调换**默认是Icon在checbox前面*****/
                /*1.***tree-folder start....end & Checkbox start 位置 被 调换****/
                /*2.***tree-hit、tree-indent部分代码发生改变，被移到 Checkbox start 后面****/
                if (opts.checkbox) {
                ...
                if (item.children && item.children.length) {
                    ...
                    if (item.state == "open") {
                        $("<span class=\"tree-icon tree-folder tree-folder-open\"></span>").addClass(item.iconCls).appendTo(node);
                        $("<span class=\"tree-hit tree-expanded\"></span>").prependTo(node);
                    } else {
                        $("<span class=\"tree-icon tree-folder\"></span>").addClass(item.iconCls).appendTo(node);
                    ...
                    if (item.state == "closed") {
                        ...
                        $("<span class=\"tree-icon tree-file\"></span>").addClass(item.iconCls).appendTo(node);
...
//var _4e6=$("<div class=\"datagrid-wrap\">"+"<div class=\"datagrid-view\">"+"<div class=\"datagrid-view1\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\">"+"<div class=\"datagrid-body-inner\"></div>"+"</div>"+"<div class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"<div class=\"datagrid-view2\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\"></div>"+"<div class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"</div>"+"</div>").insertAfter(_4e1);
        var _4e6 = $("<div class=\"datagrid-wrap\">" + "<div class=\"datagrid-view\">" + "<div class=\"datagrid-view2\">" + "<div class=\"datagrid-header\">" + "<div class=\"datagrid-header-inner\"></div>" + "</div>" + "<div class=\"datagrid-body\"></div>" + "<div class=\"datagrid-footer\">" + "<div class=\"datagrid-footer-inner\"></div>" + "</div>" + "</div>" + "</div>" + "</div>").insertAfter(_4e1);
        ...
        function _4f2(_4f7, _4f8, _4f9) {
            ...
            for (var i = 0; i < _4f8.length; i++) {
                ...
                for (var j = 0; j < cols.length; j++) {
                    ...
                    var myx = "my-head-td-" + col.field;//my-head-td-productid ... 改变datagrid-head的列宽 2-1
                    var td = $("<td class=\"" + myx + "\" " + attr + "></td>").appendTo(tr);//这个td就是datagrid-header的列 改变datagrid-head的列宽 2-2
                    if (col.checkbox) {
    ...
    function _544(_545, data) {
        ...
        if (_54a.length) {
            ...
            if (_54b.total != data.total) {
                var _523pageNum = opts.pageNumber || _54b.pageNumber;
                if (opts.pageNumber > 1 && (data.total <= ((opts.pageNumber - 1) * opts.pageSize) )) {
                    _523pageNum = _54b.pageNumber;
                }
                _54a.pagination("refresh", {pageNumber: _523pageNum, total: data.total});
        ...
        render: function (_65b, _65c, _65d) {
            ...
            for (var i = 0; i < _66b.length; i++) {
                ...
                if (col) {
                    ...
                    //var mycc=cc;// <td ck ...</>td priceid ....</> td status ....</>
                    //var myxx = col.cellClass;// datagrid-cell-c1-productid ....
                    var myff = ""; //添加改变datagrid - body列的宽度的class样式1 - 1
//if (col.checkbox) {
//    myff = "my-datagrid-check";
//} else {
//    //var i = col.cellClass.lastIndexOf("-");
//    //var s = col.cellClass.substr(i);
//    //alert(col.cellClass);
//    myff = "my-" + cellClass;//my-type,my-no....
//}
                    cc.push("<td class=\"" + _670 + "\" field=\"" + _670 + "\" " + cls + " " + _674 + ">");
                    if (col.checkbox) {
                        var _674 = "";
                    } else {
                        var _674 = _673;
